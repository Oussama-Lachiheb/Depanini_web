...
class TypepromoController extends AbstractController
{
    ...
    public function index(TypePromoRepository $typePromoRepository,PaginatorInterface $paginator,Request $request): Response
    {
        $donnees = $typePromoRepository->findAll();
